...
export const copy = {
  en: {
    ...
    nav: ['Home', 'Calendar & events', 'Notices', 'Jumuia', 'Leadership', 'Giving'],
    menu: 'Open menu',
    ...
    eventsTitle: 'Catholic calendar & parish events',
    eventsBody: 'Follow the Catholic calendar for Kenya and find confirmed parish Masses, celebrations, meetings, and community activities.',
    parishEventsTitle: 'Parish events',
  ...
  sw: {
    ...
    readingsNav: 'Masomo',
    nav: ['Mwanzo', 'Kalenda na matukio', 'Matangazo', 'Jumuia', 'Uongozi', 'Sadaka'],
    menu: 'Fungua menyu',
    ...
    eventsTitle: 'Kalenda ya Kikatoliki na matukio ya parokia',
    eventsBody: 'Fuata kalenda ya Kanisa Katoliki nchini Kenya na uone Misa, sherehe, mikutano, na shughuli zilizothibitishwa na parokia.',
    parishEventsTitle: 'Matukio ya parokia',
